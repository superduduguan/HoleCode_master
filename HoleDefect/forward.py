...
if __name__ == '__main__':
    ...
    cur_path = os.path.abspath(__file__)
    cur_dir = os.path.dirname(cur_path)
    normdir = r'C:\Users\pc\Desktop\ALL'
    ...
    for ls in LIST:
        os.mkdir(os.path.join(r'C:\Users\pc\Desktop\ALL_FORWORD', ls))

    for index in range(len(PATH)):
        src = PATH[index]
        dest = os.path.join(r'C:\Users\pc\Desktop\ALL_FORWORD', predicts(index))
        copyfile(src, dest)
